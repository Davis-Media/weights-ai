...
-- CREATE OR REPLACE TRIGGER "on_inserted_or_updated_embedding_user_exercise"
-- AFTER INSERT
-- OR
-- UPDATE OF name ON public.user_exercise FOR EACH ROW
-- EXECUTE FUNCTION supabase_functions.http_request (
--   'http://kong:8000/functions/v1/generate-exercise-embedding',
--   'POST',
